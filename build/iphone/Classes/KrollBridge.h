...
@interface ShoppingListObject : KrollCoverageObject {
#else
@interface ShoppingListObject : KrollObject {
#endif
@private
...
extern NSString * ShoppingList$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ShoppingListObject *_shoppinglist;
	BOOL shutdown;
