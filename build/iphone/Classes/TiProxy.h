...
//Rare exceptions to indicate a bug in the _shoppinglist code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ShoppingList proxies.
 */
