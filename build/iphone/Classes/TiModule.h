...
/**
 The base class for all ShoppingList modules
 */
...
/**
 ShoppingList Platform calls this method on startup.
 */
-(void)startup;

/**
 ShoppingList Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ShoppingList Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ShoppingList Platform calls this method on resume.
 @param sender The sender of the event.
 */
