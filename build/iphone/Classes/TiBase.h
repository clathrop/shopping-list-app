...
// in simulator we redefine to format for ShoppingList Developer console
...
{\
	NSString * exceptionName = [@"org.shoppinglist." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.shoppinglist";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIShoppingListNativeItemNone = -1, 
	UIShoppingListNativeItemSpinner = -2,
	UIShoppingListNativeItemProgressBar = -3,
	
	UIShoppingListNativeItemSlider = -4,
	UIShoppingListNativeItemSwitch = -5,
	UIShoppingListNativeItemMultiButton = -6,
	UIShoppingListNativeItemSegmented = -7,
	
	UIShoppingListNativeItemTextView = -8,
	UIShoppingListNativeItemTextField = -9,
	UIShoppingListNativeItemSearchBar = -10,
	
	UIShoppingListNativeItemPicker = -11,
	UIShoppingListNativeItemDatePicker = -12,
	
	UIShoppingListNativeItemInfoLight = -13,
	UIShoppingListNativeItemInfoDark = -14,
	
	UIShoppingListNativeItemDisclosure = -15,
	
	UIShoppingListNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ShoppingList instances of
