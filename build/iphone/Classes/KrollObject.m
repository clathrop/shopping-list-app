 ...
 * Copyright (c) 2009-2011 by ShoppingList, Inc. All Rights Reserved.
...
//@interface ShoppingListObject : NSObject
//@end

@interface ShoppingListObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ShoppingListObject class]])
		{
			for (NSString *key in [[(ShoppingListObject*)o modules] allKeys])
			{
